          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              <div class="icon icon-lg icon-shape bg-gradient-dark shadow-dark text-center border-radius-xl mt-n4 position-absolute">
                <i class="material-icons opacity-10">Monthly</i>
              </div>
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Water Usage</p>
                <h4 class="mb-0">53k Litres</h4>
              </div>
            </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Fertiliser Usage</p>
                <h4 class="mb-0">2,300 KG</h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              <div class="icon icon-lg icon-shape bg-gradient-info shadow-info text-center border-radius-xl mt-n4 position-absolute">
                <i class="material-icons opacity-10">March</i>
              </div>
              <div class="text-end pt-1">
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <span class="text-xs font-weight-bold">Wheat</span>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="text-xs font-weight-bold"> 20 KG </span>
                      </td>
